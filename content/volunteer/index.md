...
Maintaining and growing DC Mesh wouldn't be possible without a dedicated community of volunteers! We welcome people with diverse skill sets and from all backgrounds to help out, contribute and lead. We are open to new ideas and initiatives, especially if you are ready, willing and able to make them happen. We like people who are self-motivated and autonomous but who also like to collaborate and work with others.

If you're interested in volunteering with DC Mesh there's a few ways to get involved:
Fill out join form
...
**Here are just some of projects you could get involved with as a DC Mesh volunteer and suggested Slack channels to join** 
...
**Mesh Installer [#install](TODO)**
Installers help connect new DC Mesh members to the network (and help them reconnect when they have service issues). This involves installing and configuring routers and networking equipment on rooftops and in members' apartments and carrying out configuration.
...
Install coordinators and planners work primarily with our support ticket system to respond to [Join Form](https://dccommunitymeshinter.net/join) requests that new members submit.
...
**Maintenance Team [#maintenance-team](TODO)**: 
...
Upcoming maintenance team projects are scheduled in [#maintenance-tasks](TODO) and maintenance team is used to coordinate and plan these dates.
...
***
**Network administrator [#monitoring](TODO)**:
...
**Hardware Planner [#hardware](TODO)
...
**Neighborhood organizer [#neighborhoods](TODO)**
...
**Community outreach leader [#outreach](TODO)**
Encourage people in your community to join DC Mesh by distributing pamphlets and organizing informational events. Do you speak multiple languages? Help us reach out to people who don't speak English and provide translation assistance. We aim to be a service for all New Yorkers.
...
**Grant writer and sponsorship coordinator [#funding](TODO)**
We need help identifying grants, writing applications and reaching out to sponsors.

**Graphic Designer [#design](TODO)**
...
***
**Donate Space or Equipment [#general](TODO)**
DC Mesh accepts donations of working and reasonably modern networking equipment and antennas. We decide what to accept on a case by case basis. It's best to reach out in #general with what you have and we can let you know if we can use it.
