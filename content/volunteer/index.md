...
There's a weekly thread in [#meetings on Slack](https://slack.dccommunitymeshinter.net) where you can confirm Open Mesh Night is happening as scheduled. (We sometimes skip holidays or dates when few people are available)
...
You can also join us on [Slack](https://slack.dccommunitymeshinter.net), our community message board. We use slack to coordinate almost all mesh activities, so joining the Slack is often the first step to getting involved.
...
NYC Mesh uses a variety of Mikrotik, Cisco, Ubiquiti, and Brocade routers and switches. We use [OSPF](https://wiki.dccommunitymeshinter.net/books/5-networking/chapter/ospf) for routing inside the mesh and [BGP](https://wiki.dccommunitymeshinter.net/link/90#bkmrk-page-title) on the edge.
...
The [NYC Mesh website](https://github.com/nycmeshnet/dccommunitymeshinter.net) (what you're reading right now!) is written in markdown and hosted with Hugo. We use Github to collaboratively develop the website - both are easy to learn.
